...
def run_app():
    ...
    if arguments.input_type == 'image':
        ...
        frame_red = 0
        frame_offset = arguments.frame_offset
            ...
            if arguments.async:
                ...
                for detection in detections:
                    if detection[2] > arguments.detection_threshold:
                        ...
                        # if(frame_red+frame_offset < frame_count):
                        #     cv.rectangle(frame, (xd, yd),
                        #                  (xod, yod), (0, 0, 255), 3)
                        #     text = '{}, %: {}'.format("HUMAN",
                        #                               round(dep, 3))
                        #     cv.putText(frame, text, (xd, yd - 7),
                    ...
                    #     cv.rectangle(frame, (xd, yd),
                    #                  (xod, yod), (0, 0, 255), 3)
                    #     text = '{}, %: {}'.format("HUMAN", round(dep, 3))
                    #     cv.putText(frame, text, (xd, yd - 7),
                    #                cv.FONT_HERSHEY_PLAIN, 0.8, (0, 0, 255), 1)
                    #     print("Nothing", frame_red)
                print("Number Of Humans present : ", human_count)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--frame-offset', default=6,
                        help='Frame offset if object fails to detect')
