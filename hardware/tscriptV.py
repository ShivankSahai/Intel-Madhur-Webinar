...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-xml',
                        default="D:\Work\IntelOpenVINO\detection_retail\person-detection-retail-0013.xml",
                        help='XML File')
    parser.add_argument('--model-bin',
                        default="D:\Work\IntelOpenVINO\detection_retail\person-detection-retail-0013.bin",
                        help='BIN File')
    ...
    parser.add_argument('--input', default="D:/Work/IntelOpenVINO/videos/t1.mp4",
